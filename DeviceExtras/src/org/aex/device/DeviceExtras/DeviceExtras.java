...
* Copyright (C) 2021 The aex X Project
...
import org.aex.device.DeviceExtras.doze.DozeSettingsActivity;
import org.aex.device.DeviceExtras.FileUtils;
import org.aex.device.DeviceExtras.R;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.aex.device.DeviceExtras.HBMModeService.class);
            if (enabled) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    org.aex.device.DeviceExtras.FPSInfoService.class);
            if (enabled) {
